...
BEGIN Chain
    ...
    Name		 LEO2Missile22GS
    BEGIN Definition
        BEGIN RoutingData
            StartInst		 SatelliteCollection/HYPERION/Subset/AllLEOSWIR_Sensors
...
SatelliteCollection/HYPERION/Subset/AllLEOSat_Satellites 0 2
